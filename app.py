...
<style>
    ...
    .main-header {
        background: linear-gradient(135deg, #1B3A5C 0%, #0E1117 50%, #1a4a3a 100%);
        padding: 2rem 2.5rem;
        border-radius: 16px;
        margin-bottom: 2rem;
    ...
    .metric-card {
        background: linear-gradient(145deg, #1B2838 0%, #16202e 100%);
        padding: 1.5rem;
        border-radius: 12px;
    ...
    [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #0E1117 0%, #1B2838 100%);
    }
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    with col4:
        ...
        st.markdown(f"""
        <div class="metric-card">
            <div class="metric-label">📊 Persentase Realisasi</div>
    ...
    with col_gauge:
        st.markdown('<div class="section-header">🎯 Capaian Keseluruhan</div>', unsafe_allow_html=True)
